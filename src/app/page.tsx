...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Timeline depends on your market, offer, and budget. Many partners see first booked appointments within a week of launch. We'll give you a realistic timeline on the intro call.",
  },
  {
